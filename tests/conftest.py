...
def counter_result() -> Any:
    a = Counter({'Перевод организации': 40, 'Перевод с карты на карту': 19, 'Перевод с карты на счет': 16, 'Перевод со счета на счет': 15, 'Открытие вклада': 10})
    return a


@pytest.fixture
def description() -> list:
    return ["Перевод с карты на счет", "Перевод со счета на счет", "Открытие вклада", "Перевод организации", "Перевод с карты на карту"]
