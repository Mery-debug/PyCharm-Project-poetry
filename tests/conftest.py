...
def final_p() -> str:
    """Возвращает строку"""
    return os.path.join(os.path.abspath(__file__), "../../data/operations.json")


@pytest.fixture
def final() -> str:
    """Возвращает строку с путем до не правильного файла"""
    return os.path.join(os.path.abspath(__file__), "../../src/decorators.py")


@pytest.fixture
def trial() -> list:
    """Возвращает содержимое из json файла списком"""
...
@pytest.fixture
def triang() -> str:
    """Тестовый файл для проверки возврата типа не list"""
...
@pytest.fixture
def trans() -> dict:
    return {"date": "2024-10-20", "info": {"rate": 104.178393, "timestamp": 1729439357}, "query": {"amount": 31957.58, "from": "EUR", "to": "RUB"}, "result": 3329289.328569, "success": True}
