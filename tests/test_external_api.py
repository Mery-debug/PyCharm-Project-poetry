...
def test_return_cash(transaction: dict, mock_get: Any) -> None:
...
@patch("src.external_api.requests.request")
def test_return_cash1(transaction: dict, mock_get: Any) -> None:
    """Test of working func with error (status_code != 200)"""
    mock_get.return_value.json.return_value = {
        "date": "2024-10-20",
        "info": {"rate": 104.205462, "timestamp": 1729464905},
...
@patch("src.external_api.requests.request")
def test_return_cash2(transaction: dict, mock_get: Any) -> None:
    """Test of working func with error (status_code != 200)"""
    mock_get.return_value.json.return_value = {
        "date": "2024-10-20",
        "info": {"rate": 104.205462, "timestamp": 1729464905},
