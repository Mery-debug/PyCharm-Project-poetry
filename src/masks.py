...
def get_mask_card_number(number: str) -> str:
    ...
    if number != "":
        ...
        if len(number) == 16:
            ...
            # logger.error("Произошла ошибка: слишком короткая строка")
            return "Ошибка ввода, мало символов"
        else:
            # logger.error("Произошла ошибка: слишком длинная строка")
            return "Ошибка ввода, много символов"
    # logger.error("Произошла ошибка: пустая строка")
...
def get_mask_account(account_number: str) -> str:
    ...
    if account_number != "":
        ...
        if len(account_number) == 20:
            ...
            # logger.error("Ошибка ввода: мало символов")
            return "Ошибка ввода, мало символов"
        else:
            # logger.error("Ошибка ввода: много символов")
            return "Ошибка ввода, много символов"
    else:
        # logger.error("Ошибка ввода: вы ничего не ввели")
        return "Вы ничего не ввели"
